    ...
    public void handle(HttpExchange t) throws IOException {
        ...
        if(t.getRequestURI().getQuery() != null) {
            ...
            for (String s: parts) {
                ...
                if(mainname.equalsIgnoreCase("order") || mainname.equalsIgnoreCase("ordertype")) {
                    sort_mode = attribute;
                }
            }
            ...
            if(sort_mode != null) {
                ...
                for (OfflinePlayer player : Bukkit.getOfflinePlayers()){
                    ...
                    main_json_obj.put(player.getUniqueId(), json_obj.toString());
                }

                // do something with the request parameters
                final String responseBody = main_json_obj.toString();
